...
type Dependencies struct {
	...
	AIFlowAssetService           *service.AIFlowAssetService
	AIAssertionAssetService      *service.AIAssertionAssetService
	AIScenarioCompositionService *service.AIScenarioCompositionService
...
type API struct {
	...
	aiFlowAssetSvc           *service.AIFlowAssetService
	aiAssertionAssetSvc      *service.AIAssertionAssetService
	aiScenarioCompositionSvc *service.AIScenarioCompositionService
...
func NewRouter(deps Dependencies, corsOrigins string) http.Handler {
	a := &API{
		...
		aiFlowAssetSvc:           deps.AIFlowAssetService,
		aiAssertionAssetSvc:      deps.AIAssertionAssetService,
		aiScenarioCompositionSvc: deps.AIScenarioCompositionService,
	...
	// 固定场景资产
	aiScript.POST("/flows", a.createAIFlowAsset)
	aiScript.GET("/flows", a.listAIFlowAssets)
	aiScript.GET("/flows/:flowID", a.getAIFlowAsset)
	...
	// 断言资产
	aiScript.POST("/assertions", a.createAIAssertionAsset)
	aiScript.GET("/assertions", a.listAIAssertionAssets)
	aiScript.GET("/assertions/:assertionID", a.getAIAssertionAsset)
	aiScript.PUT("/assertions/:assertionID", a.updateAIAssertionAsset)
	aiScript.DELETE("/assertions/:assertionID", a.deleteAIAssertionAsset)
	aiScript.POST("/assertions/:assertionID/publish", a.publishAIAssertionAsset)
	aiScript.POST("/assertions/:assertionID/archive", a.archiveAIAssertionAsset)
	aiScript.GET("/assertions/:assertionID/references", a.listAIAssertionReferences)
	// 场景编排
	aiScript.POST("/compositions/ai-plan-from-task", a.createAIPlanFromTask)
	aiScript.POST("/compositions", a.createAIScenarioComposition)
	aiScript.GET("/compositions", a.listAIScenarioCompositions)
	aiScript.GET("/compositions/:compositionID", a.getAIScenarioComposition)
	aiScript.PUT("/compositions/:compositionID", a.updateAIScenarioComposition)
	aiScript.DELETE("/compositions/:compositionID", a.deleteAIScenarioComposition)
	aiScript.POST("/compositions/:compositionID/steps", a.addAIScenarioStep)
	aiScript.PUT("/compositions/:compositionID/steps/reorder", a.reorderAIScenarioSteps)
	...
	aiScript.POST("/compositions/:compositionID/publish", a.publishAIScenarioComposition)
	aiScript.POST("/compositions/:compositionID/archive", a.archiveAIScenarioComposition)
	aiScript.GET("/compositions/:compositionID/versions/diff", a.diffAIScenarioVersions)
	aiScript.POST("/compositions/:compositionID/versions/rollback", a.rollbackAIScenarioVersion)
	aiScript.GET("/compositions/:compositionID/versions", a.listAIScenarioVersions)
	aiScript.GET("/compositions/:compositionID/validations", a.listAIScenarioValidations)
	aiScript.GET("/compositions/:compositionID/references", a.listAIScenarioReferences)
	aiScript.POST("/compositions/:compositionID/ai-optimize", a.optimizeAIScenarioComposition)
	aiScript.POST("/compositions/:compositionID/ai-suggest-assertions", a.suggestAIScenarioAssertions)
	// 任务
